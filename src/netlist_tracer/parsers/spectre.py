...
def parse_spectre(
    ...
    Returns:
        Tuple of (subckts_dict, instances_list, spf_paths_list) where subckts_dict maps cell
        names to SubcktDef objects, instances_list is a list of Instance objects,
        and spf_paths_list is a list of resolved SPF file paths for lazy parsing.
    """
    ...
    # Lazy SPF parsing: return SPF paths for the parser to register as placeholders
    # (previously eager-parsed here; now deferred until BFS descent or output flushing)
    return subckts, instances, spf_include_paths
